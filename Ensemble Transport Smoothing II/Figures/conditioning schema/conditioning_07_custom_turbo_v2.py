...
plt.gca().text(0.0, 1.05, '$\mathbf{B}:$ manipulated inversion (conditioning)', transform=plt.gca().transAxes, fontsize=12,
        verticalalignment='center',horizontalalignment='left',color=[0.2,0.2,0.2])

plt.gca().text(0.02, 0.98, 'manipulated intermediate distribution', transform=plt.gca().transAxes, fontsize=10,
        verticalalignment='top',horizontalalignment='left',color='xkcd:grey')
